...
impl HFCLKSTARTEDW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            HFCLKSTARTEDW::DISABLED => false,
            HFCLKSTARTEDW::ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _HFCLKSTARTEDW<'a> {
    ...
    pub fn disabled(self) -> &'a mut W {
        self.variant(HFCLKSTARTEDW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(HFCLKSTARTEDW::ENABLED)
    }
...
impl LFCLKSTARTEDW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            LFCLKSTARTEDW::DISABLED => false,
            LFCLKSTARTEDW::ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _LFCLKSTARTEDW<'a> {
    ...
    #[inline]
    pub fn disabled(self) -> &'a mut W {
        self.variant(LFCLKSTARTEDW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(LFCLKSTARTEDW::ENABLED)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
