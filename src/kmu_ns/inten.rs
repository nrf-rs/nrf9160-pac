...
impl KEYSLOT_PUSHEDW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            KEYSLOT_PUSHEDW::DISABLED => false,
            KEYSLOT_PUSHEDW::ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _KEYSLOT_PUSHEDW<'a> {
    ...
    pub fn disabled(self) -> &'a mut W {
        self.variant(KEYSLOT_PUSHEDW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(KEYSLOT_PUSHEDW::ENABLED)
    }
...
impl KEYSLOT_REVOKEDW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            KEYSLOT_REVOKEDW::DISABLED => false,
            KEYSLOT_REVOKEDW::ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _KEYSLOT_REVOKEDW<'a> {
    ...
    #[inline]
    pub fn disabled(self) -> &'a mut W {
        self.variant(KEYSLOT_REVOKEDW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(KEYSLOT_REVOKEDW::ENABLED)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl KEYSLOT_ERRORW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            KEYSLOT_ERRORW::DISABLED => false,
            KEYSLOT_ERRORW::ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _KEYSLOT_ERRORW<'a> {
    ...
    #[inline]
    pub fn disabled(self) -> &'a mut W {
        self.variant(KEYSLOT_ERRORW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(KEYSLOT_ERRORW::ENABLED)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
