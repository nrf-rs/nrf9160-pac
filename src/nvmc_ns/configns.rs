#[doc = "Reader of register CONFIGNS"]
pub type R = crate::R<u32, super::CONFIGNS>;
#[doc = "Writer for register CONFIGNS"]
pub type W = crate::W<u32, super::CONFIGNS>;
#[doc = "Register CONFIGNS `reset()`'s with value 0"]
impl crate::ResetValue for super::CONFIGNS {
    type Type = u32;
    #[inline(always)]
