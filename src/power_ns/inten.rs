...
impl POFWARNW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            POFWARNW::DISABLED => false,
            POFWARNW::ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _POFWARNW<'a> {
    ...
    pub fn disabled(self) -> &'a mut W {
        self.variant(POFWARNW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(POFWARNW::ENABLED)
    }
...
impl SLEEPENTERW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            SLEEPENTERW::DISABLED => false,
            SLEEPENTERW::ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _SLEEPENTERW<'a> {
    ...
    #[inline]
    pub fn disabled(self) -> &'a mut W {
        self.variant(SLEEPENTERW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(SLEEPENTERW::ENABLED)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl SLEEPEXITW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            SLEEPEXITW::DISABLED => false,
            SLEEPEXITW::ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _SLEEPEXITW<'a> {
    ...
    #[inline]
    pub fn disabled(self) -> &'a mut W {
        self.variant(SLEEPEXITW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(SLEEPEXITW::ENABLED)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
