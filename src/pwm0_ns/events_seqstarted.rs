...
#[doc = "Register EVENTS_SEQSTARTED[%s] `reset()`'s with value 0"]
...
impl From<EVENTS_SEQSTARTED_A> for bool {
    ...
    fn from(variant: EVENTS_SEQSTARTED_A) -> Self {
        match variant {
            EVENTS_SEQSTARTED_A::NOTGENERATED => false,
            EVENTS_SEQSTARTED_A::GENERATED => true,
        }
    }
}
#[doc = "Reader of field `EVENTS_SEQSTARTED`"]
pub type EVENTS_SEQSTARTED_R = crate::R<bool, EVENTS_SEQSTARTED_A>;
