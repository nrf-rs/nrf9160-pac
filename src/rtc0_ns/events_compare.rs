...
impl EVENTS_COMPARER {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            EVENTS_COMPARER::NOTGENERATED => false,
            EVENTS_COMPARER::GENERATED => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> EVENTS_COMPARER {
        match value {
            false => EVENTS_COMPARER::NOTGENERATED,
            true => EVENTS_COMPARER::GENERATED,
        }
    }
    #[doc = "Checks if the value of the field is `NOTGENERATED`"]
    #[inline]
    pub fn is_not_generated(&self) -> bool {
        *self == EVENTS_COMPARER::NOTGENERATED
    }
    #[doc = "Checks if the value of the field is `GENERATED`"]
    #[inline]
    pub fn is_generated(&self) -> bool {
        *self == EVENTS_COMPARER::GENERATED
    }
}
...
impl EVENTS_COMPAREW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            EVENTS_COMPAREW::NOTGENERATED => false,
            EVENTS_COMPAREW::GENERATED => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _EVENTS_COMPAREW<'a> {
    ...
    #[inline]
    pub fn variant(self, variant: EVENTS_COMPAREW) -> &'a mut W {
        {
    ...
    pub fn not_generated(self) -> &'a mut W {
        self.variant(EVENTS_COMPAREW::NOTGENERATED)
    }
    #[doc = "Event generated"]
    #[inline]
    pub fn generated(self) -> &'a mut W {
        self.variant(EVENTS_COMPAREW::GENERATED)
    }
