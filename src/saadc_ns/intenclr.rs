...
impl<'a> _RESULTDONEW<'a> {
    ...
    #[inline]
    pub fn clear(self) -> &'a mut W {
        self.variant(RESULTDONEW::CLEAR)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl<'a> _CALIBRATEDONEW<'a> {
    ...
    #[inline]
    pub fn clear(self) -> &'a mut W {
        self.variant(CALIBRATEDONEW::CLEAR)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
