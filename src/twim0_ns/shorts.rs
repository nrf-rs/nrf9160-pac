...
impl From<LASTRX_SUSPEND_A> for bool {
    ...
    fn from(variant: LASTRX_SUSPEND_A) -> Self {
        match variant {
            LASTRX_SUSPEND_A::DISABLED => false,
            LASTRX_SUSPEND_A::ENABLED => true,
        }
    }
}
#[doc = "Reader of field `LASTRX_SUSPEND`"]
pub type LASTRX_SUSPEND_R = crate::R<bool, LASTRX_SUSPEND_A>;
...
#[doc = "Write proxy for field `LASTRX_SUSPEND`"]
