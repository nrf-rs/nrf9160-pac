...
impl<'a> _TASKS_PREPARETXW<'a> {
    ...
    #[inline]
    pub fn variant(self, variant: TASKS_PREPARETXW) -> &'a mut W {
        {
    ...
    pub fn trigger(self) -> &'a mut W {
        self.variant(TASKS_PREPARETXW::TRIGGER)
    }
...
impl W {
    ...
    #[inline]
    pub fn tasks_preparetx(&mut self) -> _TASKS_PREPARETXW {
        _TASKS_PREPARETXW { w: self }
    }
}
