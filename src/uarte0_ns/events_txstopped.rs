#[doc = "Reader of register EVENTS_TXSTOPPED"]
pub type R = crate::R<u32, super::EVENTS_TXSTOPPED>;
#[doc = "Writer for register EVENTS_TXSTOPPED"]
pub type W = crate::W<u32, super::EVENTS_TXSTOPPED>;
#[doc = "Register EVENTS_TXSTOPPED `reset()`'s with value 0"]
impl crate::ResetValue for super::EVENTS_TXSTOPPED {
    type Type = u32;
    #[inline(always)]
...
impl From<EVENTS_TXSTOPPED_A> for bool {
    ...
    fn from(variant: EVENTS_TXSTOPPED_A) -> Self {
        match variant {
            EVENTS_TXSTOPPED_A::NOTGENERATED => false,
            EVENTS_TXSTOPPED_A::GENERATED => true,
        }
    }
}
#[doc = "Reader of field `EVENTS_TXSTOPPED`"]
pub type EVENTS_TXSTOPPED_R = crate::R<bool, EVENTS_TXSTOPPED_A>;
...
#[doc = "Write proxy for field `EVENTS_TXSTOPPED`"]
