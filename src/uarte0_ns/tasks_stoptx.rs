#[doc = "Writer for register TASKS_STOPTX"]
pub type W = crate::W<u32, super::TASKS_STOPTX>;
#[doc = "Register TASKS_STOPTX `reset()`'s with value 0"]
impl crate::ResetValue for super::TASKS_STOPTX {
    type Type = u32;
    #[inline(always)]
...
impl From<TASKS_STOPTX_AW> for bool {
    ...
    fn from(variant: TASKS_STOPTX_AW) -> Self {
        match variant {
            TASKS_STOPTX_AW::TRIGGER => true,
        }
    }
}
#[doc = "Write proxy for field `TASKS_STOPTX`"]
